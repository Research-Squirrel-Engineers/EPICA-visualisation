...
def build_epica_rdf(df_ch4: pd.DataFrame, df_d18o: pd.DataFrame) -> "Graph":
    ...
    # Kein Laufzeitstempel: das Datum kommt aus der Release-Konstante, die
    # Bindung an Daten und Code aus dem Fingerabdruck.
    add_generation_provenance(
        g,
        dataset,
        GEOLOD["EPICA_DomeC_Generation"],
        inputs=[
            os.path.join(SCRIPT_DIR, "EDC_CH4.tab"),
            os.path.join(SCRIPT_DIR, "EPICA_Dome_C_d18O.tab"),
            __file__,
        ],
        agents=[URIRef("https://orcid.org/0000-0002-3246-3531")],
        label="EPICA Dome C RDF generation",
    )
...
def export_ontology():
    ...
    """
    from geo_lod_utils import GEO_LOD_RELEASE as _release
