...
| Bundle-Format | N-Triples als Voreinstellung, weil Entwicklungsläufe zählen; Turtle, JSON-LD und RDF/XML über `--bundle-format`, `release` schreibt alle. Nicht neu geschriebene Formate werden als veraltet gemeldet | 2026-08-08 |
