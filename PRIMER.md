...
| Nachführung von `README-RUN.md` | `check_docs.py` hält Skripte und Schalter gegen die Datei und meldet Abweichungen im Vorbereitungsschritt von `main.py`. Immer als Warnung: eine Dokumentationsprüfung, die einen Lauf abbricht, ist eine, die man abschaltet. Die Prosa bleibt Handarbeit — was ein Skript schreibt, weiss kein Parser | 2026-08-14 |
| `README-RUN.md` | die Referenz aller Einstiegspunkte, Schalter und Ausgaben. Wird bei jeder Änderung an einem Skript mitgeführt; ein fehlender Schalter dort ist ein Fehler. `README.md` verweist darauf und beschreibt nur noch die Form eines Laufs | 2026-08-14 |
